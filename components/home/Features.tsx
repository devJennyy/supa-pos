    ...
    <section className="w-full border-t mt-[-1px] lg:py-16 py-10">
      <div className="w-full max-w-[1440px] !mx-auto flex flex-col justify-center items-center lg:px-16 sm:px-10 px-5 lg:gap-14 gap-8">
        <div className="flex flex-col justify-center items-center gap-5">
          ...
          >
            <div className="bg-primary py-1 px-3 rounded-full">Why SupaPOS?</div>
        ...
        <div className="hidden lg:grid w-full grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-5 gap-4">
            ...
            <div className="h-full md:rounded-2xl rounded-lg border bg-secondaryBackground flex flex-col">
              ...
              <div className="flex-1 flex flex-col gap-4 mt-4 pb-4">
                <div className="w-full flex justify-end">
                  <motion.div
                    className="w-5/6 h-10 rounded-l-full bg-gradient-to-r from-input to-input/5"
                    initial={{ scaleX: 0 }}
                ...
                <div className="w-full flex justify-start overflow-hidden">
                  <motion.div
                    className="w-5/6 h-10 rounded-r-full bg-gradient-to-l from-input to-input/5"
                    initial={{ scaleX: 0 }}
                    whileInView={{ scaleX: 1 }}
                    viewport={{ once: false, amount: 0.3 }}
                    transition={{
          ...
          <div className="row-span-2 lg:h-175 md:h-85 h-32 md:rounded-3xl rounded-2xl md:p-2 p-1 border">
            <div className="h-full md:rounded-2xl rounded-lg border bg-secondaryBackground flex flex-col justify-between">
              <motion.div
              ...
              >
                ...
                >
                  ...
                  <div>
                    <h3 className="font-semibold text-lg text-white">Tablet</h3>
                    <p className="text-secondary text-sm">
                ...
                >
                  ...
                  <div>
                    <h3 className="font-semibold text-lg text-white">Web</h3>
                    <p className="text-secondary text-sm">
              ...
              >
                <h1 className="text-xl font-semibold">Responsive Design</h1>
                <p className="text-secondary text-sm">
          ...
          <div className="lg:col-span-2 md:h-85 h-32 md:rounded-3xl rounded-2xl md:p-2 p-1 border overflow-hidden">
            <div className="flex h-full md:rounded-2xl rounded-lg border bg-secondaryBackground overflow-hidden">
              ...
              >
                <h1 className="text-xl font-semibold">Modern & Innovative</h1>
                <p className="text-secondary text-sm">
